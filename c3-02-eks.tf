  ...
  eks_managed_node_groups = merge(
    {
      linux = {
        ...
        use_latest_ami_release_version = (var.lin_release_version == null)
      ...
      windows = {
        ...
        use_latest_ami_release_version = (var.win_release_version == null)
        tags = {
          "k8s.io/cluster-autoscaler/enabled"                 = "true",
          "k8s.io/cluster-autoscaler/${var.eks_cluster_name}" = "owned"
        }
    ...
    { for ng in var.custom_node_groups : ng.name => {
      ...
      use_latest_ami_release_version = (try(ng.release_version, null) == null)
