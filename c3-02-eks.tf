  ...
  eks_managed_node_groups = merge(
    {
      linux = {
        ...
        instance_market_options = ( var.lin_capacity_type == "SPOT" ? merge({ market_type = "spot" }, var.lin_instance_market_options) : {}                                                                # omit completely
)
      ...
      windows = {
        ...
        instance_market_options = var.win_capacity_type == "SPOT" ? var.win_instance_market_options : { market_type = null, spot_options = null }
    ...
    { for ng in var.custom_node_groups : ng.name => {
      ...
      instance_market_options = (ng.capacity_type == "SPOT" && ng.instance_market_options != null ? ng.instance_market_options : { market_type = null, spot_options = null })
